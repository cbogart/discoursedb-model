...
**STEP 4:**: A DataSource can be added to content and contribution 		```DataSourceService.addSource(curContent, new DataSourceInstance(SOURCE_ID,SOURCE_ID_DESCRIPTOR,SOURCE_TYPE, DATA_SET_NAME))```
