...
**STEP 5:**: A contribution can be associated with a DiscoursPart using ```discoursePartService.addContributionToDiscoursePart(Contribution contrib, DiscoursePart part)```
